...
/**
 * @class PostCarouselUnchainedModule
 */
class PostCarouselUnchainedModule extends FLBuilderModule {
	...
	public function __construct()
	{
		parent::__construct(array(
			'name'          	=> __('Posts Carousel (Unchained)', 'fl-builder'),
			'description'   	=> __('Display a carousel of your WordPress posts, but without a link to the post.', 'fl-builder'),
 ...
 */
FLBuilder::register_module('PostCarouselUnchainedModule', array(
	'slider'      => array(
